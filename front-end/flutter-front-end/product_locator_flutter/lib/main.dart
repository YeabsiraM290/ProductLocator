...
// import 'package:product_locator_flutter/views/home_view.dart';
import 'package:device_preview/device_preview.dart';
import 'package:product_locator_flutter/Presentation/widgets/Login/login_content/login_content_mobile.dart';
import 'package:product_locator_flutter/Presentation/widgets/routes/router.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
              create: (context) =>
                  ProfileBloc(ProfileInitState(), ProfileRepo())),
        ],
        child: MaterialApp(
          routes: routes,
