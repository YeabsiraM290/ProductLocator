...
class ShopMobilePortrait extends StatelessWidget {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  ShopMobilePortrait({Key? key}) : super(key: key);
...
class ShopMobileLandscape extends StatelessWidget {
  const ShopMobileLandscape({Key? key}) : super(key: key);
