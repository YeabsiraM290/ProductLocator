...
import 'package:product_locator_flutter/Presentation/views/wish_list_view/wish_list_view_mobile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      mobile: OrientationLayout(
        portrait: WishListMobilePortrait(),
        landscape: const WishListMobileLandscape(),
      ),
