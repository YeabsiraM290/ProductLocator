...
class WishListMobilePortrait extends StatelessWidget {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  WishListMobilePortrait({Key? key}) : super(key: key);
...
class WishListMobileLandscape extends StatelessWidget {
  const WishListMobileLandscape({Key? key}) : super(key: key);
