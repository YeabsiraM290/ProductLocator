...
import 'package:product_locator_flutter/Presentation/views/vendor/vendor_view_mobile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      mobile: OrientationLayout(
        portrait: VendorMobilePortrait(),
        landscape: const VendorMobileLandscape(),
      ),
