...
class VendorMobilePortrait extends StatelessWidget {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  VendorMobilePortrait({Key? key}) : super(key: key);
          ...
          itemBuilder: (context, index) {
            return Column(
                ...
                children: [
                  ...
                  // const VendorContentMobilePortrait(),
...
class VendorMobileLandscape extends StatelessWidget {
  const VendorMobileLandscape({Key? key}) : super(key: key);
