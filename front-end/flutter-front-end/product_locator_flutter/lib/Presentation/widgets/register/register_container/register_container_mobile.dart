...
// import 'package:product_locator_flutter/widgets/register/register_container/register_container.dart';
...
class RegisterContainerMobile extends StatelessWidget {
  const RegisterContainerMobile({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: Column(children: [
          const HomeTitle(),
          Column(
            children: RegisterContainer.getRegister(),
          ),
        ]));
  }
}
