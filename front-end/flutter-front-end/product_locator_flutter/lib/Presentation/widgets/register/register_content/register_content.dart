...
import 'package:product_locator_flutter/Presentation/widgets/register/register_content/register_content_mobile.dart';
// import 'package:product_locator_flutter/responsive/Screen_type.dart';
import 'package:flutter/material.dart';
// import 'package:product_locator_flutter/widgets/register/register_content/register_content_mobile.dart';
...
class RegisterContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout(
      mobile: RegisterContentMobilePortrait(
          color: color,
          image: image,
          detail: detail,
